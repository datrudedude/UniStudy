...
# стандартной библиотекой, и считаем разницу медианы со всеми остальными элементами, а дальше пишем строку в файл,
# и так по кругу, ибо никто не сказал сколько данных всего передадут. НЕБОЛЬЩОЕ ПОЯСНЕНИЕ КАСАТЕЛЬНО ПОБИТОВЫХ
# ОПЕРАЦИЙ: !Вся работа с отсечением битов, это работа со строками, да можно было бы использовать и побитовые
# операции, и высчитывать модуль и целочисленное деление, но в рот оно ебись в питоне проще было сделать через
# строки(в основном из-за проблемы с записью ведущих нулей, главное что работает и быстро, условия к написанию проги
# выполнены, никаких другие библиотеки, кроме стандартных не используются!
